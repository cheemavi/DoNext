...
function ListOptions(){
    ...
    const [isOpen, setIsOpen] = useState(false);
     ...
     const handleClearList = ()=>{
      ...
      const handleDownloadList = ()=>{
        //this means its an empty list
        if(tasks.length===0){
            return;
        }
        
        //insert current date for to do list title:
    ...
    return( <div className=" flex flex-col">
                <button
                    ...
                    className="cursor-pointer shadow font-semibold text-sm whitespace-nowrap relative hover:bg-violet-700  py-3 px-4 bg-violet-300 rounded-sm dark:bg-stone-900 dark:text-slate-400 dark:hover:bg-stone-600 dark:hover:text-white"
                >
